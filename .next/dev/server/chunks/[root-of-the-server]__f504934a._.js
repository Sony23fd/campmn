...
async function GET() {
    try {
        const docs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.findMany({
            orderBy: [
                {
                    order: "asc"
                },
...
async function POST(request) {
    try {
        ...
        const documentType = formData.get("documentType") || "LEGISLATION";
        let fileUrl = "";
        if (file) {
        ...
        const doc = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].document.create({
            data: {
                title,
                fileUrl,
                documentType
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f504934a._.js.map