...
async function POST(request) {
    try {
        ...
        const existingAuthor = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
            where: {
                id: authorIdToUse
            }
        });
        if (!existingAuthor) {
            // Find any valid user
            const fallbackUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst();
            if (fallbackUser) {
                authorIdToUse = fallbackUser.id;
            } else {
                // Create a temporary default admin if database is completely empty
                const newAdminUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                    data: {
                        email: "admin@zus.mn",
                        name: "System Admin",
                        role: "SUPERADMIN"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__106e715f._.js.map