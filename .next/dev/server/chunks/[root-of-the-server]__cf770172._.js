...
async function GET(request) {
    try {
        ...
        const events = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].event.findMany({
            where: whereClause,
            orderBy: {
                startDate: "asc"
            },
...
async function POST(request) {
    try {
        ...
        const event = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].event.create({
            data: {
                title: body.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf770172._.js.map