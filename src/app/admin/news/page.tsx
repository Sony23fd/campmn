...
export default function AdminPosts() {
    ...
    const handleCancel = () => {
        ...
        setEditingId(null);
        setFormData({ 
            title: "", slug: "", content: "", excerpt: "", imageUrl: "", type: "NEWS", published: true, 
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Мэдээлэл</h1>
                    <p className="text-muted-foreground">Вэбсайтад орох мэдээ мэдээллийн хэсэг.</p>
                </div>
                <button
