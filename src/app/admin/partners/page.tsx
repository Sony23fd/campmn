                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 p-6 border rounded-xl bg-card">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <option value="NATIONAL">Үндэсний хэмжээнд</option>
                                <option value="INTERNATIONAL">Олон улсын түвшний</option>
                            </select>
                        </div>
                        <div className="space-y-2">
                                    ...
                                    partners.map(partner => (
                                        <tr key={partner.id} className="hover:bg-slate-50">
                                            ...
                                            <td className="px-6 py-4">
                                                ...
                                                <div className="text-xs font-semibold px-2 py-0.5 rounded-full inline-block mt-1 bg-slate-100 text-slate-600">
                                                    {partner.type === 'NATIONAL' ? 'Үндэсний' : partner.type === 'INTERNATIONAL' ? 'Олон улсын' : partner.type}
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <button
